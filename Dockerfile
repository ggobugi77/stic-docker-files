...
RUN apt update && apt install -y vim unzip curl wget bzip2 pwgen \
...
RUN apt-get update \
	&& apt-get install -y re2c libmcrypt-dev libzip-dev libss-dev libtidy-dev libpng16-16 libpng-dev libjpeg-dev libbz2-dev libcurl4-gnutls-dev libxml2 libxml2-dev librecode-dev\
